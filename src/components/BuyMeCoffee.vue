<template>
    <a href="https://buymeacoffee.com/kenjiakira" target="_blank" class="bmc-button" title="Buy me a coffee">
      <span class="tooltip">Support me</span>
